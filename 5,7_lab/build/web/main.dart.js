...
define('zapp_user_main', ['dart_sdk', 'flutter_sdk'], (function load__zapp_user_main(dart_sdk, flutter_sdk) {
  ...
  dart.defineLazy(CT, {
    ...
    get C21() {
      return C[21] = dart.const({
        ...
        [ListTile_trailing]: null,
        [ListTile_subtitle]: null,
        [ListTile_title]: C[22] || CT.C22,
        [ListTile_leading]: null
      });
    },
    get C13() {
      return C[13] = dart.constList([C[14] || CT.C14, C[16] || CT.C16, C[17] || CT.C17, C[16] || CT.C16, C[19] || CT.C19, C[16] || CT.C16, C[21] || CT.C21], framework.Widget);
    },
    get C24() {
      return C[24] = dart.const({
        __proto__: ui.Color.prototype,
        [Color_value]: 4288486621
      });
    },
    get C23() {
  ...
  var I = [
    ...
    "file:///zapp/project/lib/screen/home_screen.dart",
    "file:///zapp/project/lib/screen/simple_list_screen.dart",
    "file:///zapp/project/lib/screen/infinity_list_screen.dart",
    "file:///zapp/project/lib/screen/infinity_math_screen.dart",
    "file:///zapp/project/lib/screen/choice_screen.dart"
  ];
  ...
  home_screen.HomeScreen = class HomeScreen extends framework.StatelessWidget {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({centerTitle: true, title: C[7] || CT.C7, backgroundColor: new ui.Color.fromARGB(255, 157, 28, 221)}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([new elevated_button.ElevatedButton.new({child: C[8] || CT.C8, onPressed: dart.fn(() => navigator.Navigator.pushNamed(T.ObjectN(), context, "/simple"), T.VoidTovoid()), style: elevated_button.ElevatedButton.styleFrom({backgroundColor: new ui.Color.fromARGB(255, 157, 28, 221)})}), C[9] || CT.C9, new elevated_button.ElevatedButton.new({child: C[10] || CT.C10, onPressed: dart.fn(() => navigator.Navigator.pushNamed(T.ObjectN(), context, "/infinity"), T.VoidTovoid()), style: elevated_button.ElevatedButton.styleFrom({backgroundColor: new ui.Color.fromARGB(255, 157, 28, 221)})}), C[9] || CT.C9, new elevated_button.ElevatedButton.new({child: C[11] || CT.C11, onPressed: dart.fn(() => navigator.Navigator.pushNamed(T.ObjectN(), context, "/math"), T.VoidTovoid()), style: elevated_button.ElevatedButton.styleFrom({backgroundColor: new ui.Color.fromARGB(255, 157, 28, 221)})}), C[9] || CT.C9, new elevated_button.ElevatedButton.new({child: C[12] || CT.C12, onPressed: dart.fn(() => async.async(dart.void, function*() {
                ...
                }), T.VoidToFutureOfvoid()), style: elevated_button.ElevatedButton.styleFrom({backgroundColor: new ui.Color.fromARGB(255, 157, 28, 221)})})])})})});
    }
  };
  ...
  simple_list_screen.SimpleListScreen = class SimpleListScreen extends framework.StatelessWidget {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[8] || CT.C8, backgroundColor: new ui.Color.fromARGB(255, 157, 28, 221)}), body: new scroll_view.ListView.new({children: C[13] || CT.C13})});
    }
  };
  ...
  infinity_list_screen._InfinityListScreenState = class _InfinityListScreenState extends framework.State$(infinity_list_screen.InfinityListScreen) {
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[10] || CT.C10, backgroundColor: new ui.Color.fromARGB(255, 157, 28, 221)}), body: new scroll_view.ListView.builder({itemBuilder: dart.fn((context, i) => {
            if (i[$isOdd]) return C[23] || CT.C23;
  ...
  infinity_math_screen._InfinityMathScreenState = class _InfinityMathScreenState extends framework.State$(infinity_math_screen.InfinityMathScreen) {
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[11] || CT.C11, backgroundColor: new ui.Color.fromARGB(255, 157, 28, 221)}), body: new scroll_view.ListView.builder({itemBuilder: dart.fn((context, i) => {
            if (i[$isOdd]) return C[25] || CT.C25;
            let index = (i / 2)[$truncate]();
            if (index >= this[_items$][$length]) {
  ...
  choice_screen.ChoiceScreen = class ChoiceScreen extends framework.StatelessWidget {
    ...
    build(context) {
      return new scaffold.Scaffold.new({appBar: new app_bar.AppBar.new({title: C[26] || CT.C26, backgroundColor: new ui.Color.fromARGB(255, 157, 28, 221)}), body: new basic.Center.new({child: new basic.Column.new({mainAxisAlignment: flex.MainAxisAlignment.center, children: T.JSArrayOfWidget().of([new elevated_button.ElevatedButton.new({onPressed: dart.fn(() => navigator.Navigator.pop(core.String, context, "Да"), T.VoidTovoid()), child: C[27] || CT.C27, style: elevated_button.ElevatedButton.styleFrom({backgroundColor: new ui.Color.fromARGB(255, 157, 28, 221)})}), new elevated_button.ElevatedButton.new({onPressed: dart.fn(() => navigator.Navigator.pop(core.String, context, "Нет"), T.VoidTovoid()), child: C[28] || CT.C28, style: elevated_button.ElevatedButton.styleFrom({backgroundColor: new ui.Color.fromARGB(255, 157, 28, 221)})})])})})});
    }
  };
  ...
  dart.trackLibraries("zapp_user_main", {
    ...
    "file:///zapp/project/lib/screen/home_screen.dart": home_screen,
    "file:///zapp/project/lib/screen/simple_list_screen.dart": simple_list_screen,
    "file:///zapp/project/lib/screen/infinity_list_screen.dart": infinity_list_screen,
    "file:///zapp/project/lib/screen/infinity_math_screen.dart": infinity_math_screen,
    "file:///zapp/project/lib/screen/choice_screen.dart": choice_screen
  }, {
  }, '{"version":3,"sourceRoot":"","sources":["/zapp/project/.zapp_entry.dart","/zapp/project/lib/main.dart","/zapp/project/.dart_tool/dartpad/web_plugin_registrant.dart","/zapp/project/lib/screen/home_screen.dart","/zapp/project/lib/screen/simple_list_screen.dart","/zapp/project/lib/screen/infinity_list_screen.dart","/zapp/project/lib/screen/infinity_math_screen.dart","/zapp/project/lib/screen/choice_screen.dart"],"names":[],"mappings":";;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;AA2CI,IA1BF,iCAAgB;AACd,UAAoB,6BAGD;AAF8B,QAA9B,AAAkB,6BAElB,eAF2B;;AAEL,QAAF,CAApB;;AAEnB,UAAO,AAAQ,uBAAY;AAKvB,QAJK,AAAqC,qBAA7B,qCAAuB,uBAAW,QAAC;AAG9C,UAFC,AAAQ,sBAAW,2BAA2B,CAC/C;;;wBAIL,SAAC,GAAG;AACL,UAAO,AAAQ,uBAAY;AAIvB,QAHC,AAAQ,sBAAW,wBAAwB,CAC5C,AAAE,CAAD,eACD,AAAW,UAAD;;2DAGM,yCACb,SAAC,MAAM,QAAQ,MAAM;AAC1B,cAAO,AAAQ,uBAAY;AAC4B,YAAlD,AAAQ,sBAAW,wBAAwB,CAAC,IAAI;;;EAI3D;;AAEiB;AAQd,MAPD,MAAS,gCACC;AACS,UAAf;6CAEe;AACmB,UAAjB;;IAGvB;;;;;;;;UC1C4B;AACxB,YAAO,iCACE,qCACO,aACN,yDACN,KAAK,QAAC,yDACN,WAAW,QAAC,+DACZ,aAAa,QAAC,iEACd,SAAS,QAAC,iEACV,WAAW,QAAC;IAGlB;;;QAfmB;AAAb,8CAAa,GAAG;;EAAE;;;;;;;;;AAHX;EAAqB;;ECAZ;;;;;;;;;;;;;;;;;;;;;;;;UCDI;AACxB,YAAO,oCACG,qCAAoB,6CAAiE,sBAAS,KAAK,KAAK,IAAI,cAC9G,6BACG,yCACgC,yCAC3B,wBACR,yEAEa,cAAgB,2CAAU,OAAO,EAAE,oCACxB,2DACC,sBAAS,KAAK,KAAK,IAAI,yBAIhD,2EAEa,cAAgB,2CAAU,OAAO,EAAE,sCACxB,2DACC,sBAAS,KAAK,KAAK,IAAI,yBAIhD,2EAEa,cAAgB,2CAAU,OAAO,EAAE,kCACxB,2DACC,sBAAS,KAAK,KAAK,IAAI,yBAIhD,2EAEa;AACH,gCAAS,MAAgB,2CAAU,OAAO,EAAE;AAClD,sBAAI,MAAM;AAGP,oBAFiB,AAAY,8BAAT,OAAO,eAC1B,qCAAkB,kBAAK,AAAqB,0BAAP,MAAM;;gBAGjD,oCACsB,2DACC,sBAAS,KAAK,KAAK,IAAI;IAO1D;;;QApDwB;AAAlB,0DAAkB,GAAG;;EAAE;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;UCGH;AACxB,YAAO,oCACG,+DAAmE,sBAAS,KAAK,KAAK,IAAI,cAC5F;IAYV;;;QAlB8B;AAAxB,uEAAwB,GAAG;;EAAE;;;;;;;;;;;;;;ACGQ;IAA0B;;;QAHrC;AAA1B,2EAA0B,GAAG;;EAAE;;;;;;;;;;;UAUX;AACxB,YAAO,oCACG,iEAAuE,sBAAS,KAAK,KAAK,IAAI,cACvF,+CACA,SAAC,SAAS;AACrB,gBAAI,AAAE,CAAD,UAAQ;AAEP,wBAAU,CAAF,CAAC,GAAI;AACnB,gBAAI,AAAM,KAAD,IAAI,AAAO;AACqC,cAAvD,AAAO,sBAAO,wBAAC,AAAe,qBAAN,KAAK,GAAG,AAAqB,qBAAX,AAAM,KAAD,GAAG;;AAGpD,kBAAO,oCAAgB,kBAAK,AAAM,oBAAC,KAAK;;IAIhD;;;;;;IAnBmB,eAAS;;;EAoB9B;;;;;;;;;;;;;;;;;;ACvB6C;IAA0B;;;QAHrC;AAA1B,2EAA0B,GAAG;;EAAE;;;;;;;;;;UAUX;AACxB,YAAO,oCACG,iEAAoE,sBAAS,KAAK,KAAK,IAAI,cACpF,+CACA,SAAC,SAAS;AACrB,gBAAI,AAAE,CAAD,UAAQ;AAEP,wBAAU,CAAF,CAAC,GAAI;AACnB,gBAAI,AAAM,KAAD,IAAI,AAAO;AAIhB,cAHF,AAAO,uBAAO,wBACZ,AAA6B,gBAAzB,KAAK,qBAAK,SAAI,GAAG,KAAK,IAC1B,AACF,gBADO,AAAM,KAAD,GAAG,KAAE,iBAAK,SAAI,GAAG,AAAM,KAAD,GAAG;;AAIvC,kBAAO,oCAAgB,kBAAK,AAAM,qBAAC,KAAK;;IAIhD;;;;;;IAtBmB,gBAAS;;;EAuB9B;;;;;;;;;;;;;;;;;UC5B4B;AACxB,YAAO,oCACG,iEAA0D,sBAAS,KAAK,KAAK,IAAI,cACnF,6BACG,yCACgC,yCAC3B,wBACR,mDACa,cAAgB,qCAAI,OAAO,EAAE,uDAElB,2DACC,sBAAS,KAAK,KAAK,IAAI,UAGhD,mDACa,cAAgB,qCAAI,OAAO,EAAE,wDAElB,2DACC,sBAAS,KAAK,KAAK,IAAI;IAO1D;;;QA5B0B;AAApB,8DAAoB,GAAG;;EAAE","file":"main.js"}');
  // Exports:
  return {
    zapp__project__$46zapp_entry: $46zapp_entry,
    zapp__project__lib__main: main,
    zapp__project__$46dart_tool__dartpad__web_plugin_registrant: web_plugin_registrant,
    zapp__project__lib__screen__home_screen: home_screen,
    zapp__project__lib__screen__simple_list_screen: simple_list_screen,
    zapp__project__lib__screen__infinity_list_screen: infinity_list_screen,
    zapp__project__lib__screen__infinity_math_screen: infinity_math_screen,
    zapp__project__lib__screen__choice_screen: choice_screen
  };
}));
